...
public class AccountController {
	...
	public ResponseEntity<?> getTransactions(@RequestBody @Valid PeriodDto periodDto) {
		return new ResponseEntity<>(accountService.periodTransaction(
				periodDto.getAccountNumber(),
				periodDto.getAccountPassword(),
				periodDto.getStartDt(),
				periodDto.getEndDt()), HttpStatus.OK);
	}
}
